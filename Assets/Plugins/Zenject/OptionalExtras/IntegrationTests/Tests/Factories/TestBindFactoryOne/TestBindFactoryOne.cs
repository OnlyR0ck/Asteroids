...
namespace Zenject.Tests.Factories
{
    ...
    {
        GameObject FooPrefab => FixtureUtil.GetPrefab("TestBindFactoryOne/Foo");

        GameObject FooSubContainerPrefab => FixtureUtil.GetPrefab("TestBindFactoryOne/FooSubContainer");
