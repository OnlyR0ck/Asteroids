...
namespace Zenject.Tests.Factories
{
    ...
    {
        GameObject FooPrefab => FixtureUtil.GetPrefab("TestBindFactoryFive/Foo");

        GameObject FooSubContainerPrefab => FixtureUtil.GetPrefab("TestBindFactoryFive/FooSubContainer");
