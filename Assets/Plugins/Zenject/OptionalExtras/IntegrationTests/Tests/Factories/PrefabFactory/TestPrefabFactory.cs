...
namespace Zenject.Tests.Factories
{
    ...
    {
        string FooPrefabResourcePath => "TestPrefabFactory/Foo";

        GameObject FooPrefab => FixtureUtil.GetPrefab(FooPrefabResourcePath);

        string Foo2PrefabResourcePath => "TestPrefabFactory/Foo2";

        GameObject Foo2Prefab => FixtureUtil.GetPrefab(Foo2PrefabResourcePath);
