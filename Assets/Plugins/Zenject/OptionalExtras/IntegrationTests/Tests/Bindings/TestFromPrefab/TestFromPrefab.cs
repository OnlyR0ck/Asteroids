...
namespace Zenject.Tests.Bindings
{
    ...
    {
        GameObject FooPrefab => GetPrefab("Foo");

        GameObject GorpPrefab => GetPrefab("Gorp");

        GameObject GorpAndQuxPrefab => GetPrefab("GorpAndQux");

        GameObject NorfPrefab => GetPrefab("Norf");

        GameObject JimAndBobPrefab => GetPrefab("JimAndBob");
