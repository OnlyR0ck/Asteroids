...
namespace Zenject.Tests.Bindings
{
    ...
    {
        GameObject FooPrefab => FixtureUtil.GetPrefab("TestFromSubContainerPrefab/Foo");

        GameObject CircFooPrefab => FixtureUtil.GetPrefab("TestFromSubContainerPrefab/CircFoo");

        GameObject FooPrefab2 => FixtureUtil.GetPrefab("TestFromSubContainerPrefab/Foo2");
