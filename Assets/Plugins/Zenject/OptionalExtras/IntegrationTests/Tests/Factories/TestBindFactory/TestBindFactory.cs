...
namespace Zenject.Tests.Factories
{
    ...
    {
        GameObject FooPrefab => FixtureUtil.GetPrefab("TestBindFactory/Foo");

        GameObject CameraPrefab => FixtureUtil.GetPrefab("TestBindFactory/Camera");

        GameObject FooSubContainerPrefab => FixtureUtil.GetPrefab("TestBindFactory/FooSubContainer");
